...
(function () {
  ...
  function performSearch() {
    ...
    if (elements.resultsTableContainer) elements.resultsTableContainer.style.display = 'block';
    ...
    if (elements.resultsTableBody) {
      elements.resultsTableBody.innerHTML = '<tr><td colspan="12" style="text-align: center; padding: 40px;">Searching...</td></tr>';
    }
    ...
    .catch(error => {
      ...
      if (elements.resultsTableBody) {
        elements.resultsTableBody.innerHTML = '<tr><td colspan="12" style="text-align: center; padding: 40px; color: #e74c3c;">Error searching for parts. Please try again.</td></tr>';
      }
    });
  }
          ...
          (part) => {
            ...
            return `
                <tr data-part-code="${code}">
                    ...
                    <td>
                        <strong class="row-total">${formatPrice(price)}</strong> AED
                    </td>
                </tr>
            `;
          }
