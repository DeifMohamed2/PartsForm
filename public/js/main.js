...
(function () {
  ...
  function initializeMainJS() {
    ...
    const searchDropdown = document.querySelector('.nav-dropdown');

    if (searchDropdownBtn && searchDropdownMenu && searchDropdown) {
      ...
      const dropdownItems =
        searchDropdownMenu.querySelectorAll('.nav-dropdown-item');
    ...
    navLinks.forEach((link) => {
      link.addEventListener('click', (e) => {
        ...
        // For regular page links (like /buyer/affiliate), let the browser handle navigation normally
      });
    });
    ...
    // Note: Sign-in form submission is handled by buyer-auth.js
    // No handler needed here to avoid conflicts
